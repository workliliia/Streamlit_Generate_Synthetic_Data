...
st.set_page_config(page_title="CTGAN + Decision Tree Prediction", layout="wide")
...
def build_scenario_table(original_df, dt_prediction_df):
    ...
    scenario_table_36 = scenario_table_36[
        ["Flap deflection", "ANGLE OF ATTACK", "Force Quantities",
         "Vertical Force original", "Vertical Force Decision Tree", "Experimental"]
    ]
...
# main GUI
st.title("CTGAN + Decision Tree Prediction")
st.write("Upload `WindTunnelData.csv`, train the CTGAN model, generate synthetic data, and evaluate Decision Tree prediction.")
        ...
        if missing_cols:
            ...
            if st.session_state.dt_prediction_df is not None:
                ...
                st.download_button(
                    ...
                    file_name="CTGAN_DecisionTree_Predictions.csv",
                    mime="text/csv"
                )
            ...
            if st.session_state.scenario_table is not None:
                ...
                st.download_button(
                    ...
                    file_name="CTGAN_DecisionTree_Table.csv",
                    mime="text/csv"
                )
